"""
Pozorovatel je jedním z nejdůležitějších a v praxi často používaných vzorů.
Popisuje, jak vytvořit vztah one-to-many tak, aby ostatní byli informováni o aktualizaci stavu jednoho objektu.

Příkladem takového vzoru je jeden kanál na komunikátoru. Na kanálu může být mnoho uživatelů a aktualizace
stavu jedním z nich (tj. odeslání zprávy na kanál) způsobí, že ostatní uživatelé obdrží informaci o
této skutečnosti (v okně zprávy se objeví odeslaná zpráva).

Design
Abychom mohli vybudovat vztah typu one-to-many, potřebujeme:
rozhraní společné pro všechny sledující (tzv. observer)
objekt, často nazývaný observable nebo subject

Kromě toho musí existovat způsob, jak:
spojit pozorovatele s pozorovaným objektem
pozorovatel může reagovat na změnu stavu
"""
